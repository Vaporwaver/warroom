        ...
        if is_git:
            ...
            if st.sidebar.button("🔄 Buscar Actualizaciones", use_container_width=True):
                if not github_token_val:
                    st.sidebar.error("❌ Se requiere un GitHub Token para la descarga automática. Configúralo arriba o usa la opción de actualización manual subiendo el archivo ZIP.")
                else:
                    with st.spinner("Buscando e instalando actualizaciones desde GitHub..."):
                        try:
                            ...
                            # API endpoint for private zipball download
                            url = "https://api.github.com/repos/Vaporwaver/warroom/zipball/main"
