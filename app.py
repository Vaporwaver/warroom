...
c_toggle.toggle("Radio", value=st.session_state.get("media_radio_active", True), key="media_radio_active", on_change=save_bool_config, args=("media_radio_active", "config_media_radio_active"), disabled=st.session_state.monitoring_active, label_visibility="collapsed")
...
c_toggle.toggle("TV", value=st.session_state.get("media_tv_active", True), key="media_tv_active", on_change=save_bool_config, args=("media_tv_active", "config_media_tv_active"), disabled=st.session_state.monitoring_active, label_visibility="collapsed")
...
c_toggle.toggle("YouTube", value=st.session_state.get("media_youtube_active", True), key="media_youtube_active", on_change=save_bool_config, args=("media_youtube_active", "config_media_youtube_active"), disabled=st.session_state.monitoring_active, label_visibility="collapsed")
...
c_toggle.toggle("Instagram", value=st.session_state.get("media_instagram_active", True), key="media_instagram_active", on_change=save_bool_config, args=("media_instagram_active", "config_media_instagram_active"), disabled=st.session_state.monitoring_active, label_visibility="collapsed")
...
c_toggle.toggle("Twitter", value=st.session_state.get("media_twitter_active", True), key="media_twitter_active", on_change=save_bool_config, args=("media_twitter_active", "config_media_twitter_active"), disabled=st.session_state.monitoring_active, label_visibility="collapsed")
